...
public class Health : MonoBehaviour
{
	...
	public float startingHealth = 100.0f;		// The starting health
	public float maxHealth = 100.0f;			// The maximum health
	private float currentHealth;				// The current ammount of health

	public bool replaceWhenDead = false;		// Whether or not a dead replacement should be instantiated. 
